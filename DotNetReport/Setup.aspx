<%@ Page Title="Report Setup" Language="C#" MasterPageFile="~/DotNetReport/ReportLayout.Master" AutoEventWireup="true" CodeBehind="Setup.aspx.cs" Inherits="ReportBuilder.Demo.WebForms.DotNetReport.Setup" Async="true" %>
                ...
                <div class="menu row" data-bind="with: Tables" style="margin-left: 20px;">
                    ...
                    <div class="menu-category card">
                        ...
                        <div data-bind="attr: {id: 'table'+$index()}" class="panel-collapse collapse in">
                            <div class="card-body">
                                <p>
                                    <label class="label-xs">Display Name</label><br />
                                    <span data-bind="editable: DisplayName"></span></p>
                                <p>
                                    <label class="label-xs">Account Id Field</label><br />
                                    <span data-bind="editable: AccountIdField"></span></p>
                            </div>
                            ...
                            <div class="list-group-item">
                                <div class="checkbox">
                                    ...
                                    <button class="btn btn-sm pull-right" data-toggle="modal" data-target="#column-modal" title="All column options" data-bind="click: $root.selectColumn">...</button>
                    ...
                    <div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <span data-bind="visible:ForeignKey()" data-toggle="tooltip" data-placement="right" class="fa fa-question-circle helptip" style="display: none;" title="Foreign Value field is a Column from the Foreign table which is used to display the value to the User in the Wizard"></span>
                                </div>
                            </div>
                        </div>
