<%@ Page Title="" Language="C#" MasterPageFile="~/DotNetReport/ReportLayout.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ReportBuilder.Demo.WebForms.DotNetReport.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="alert alert-warning">
        You can integrate the Report Builder Builder in your Application using <a href="https://www.nuget.org/packages/dotNetReport/">this Nuget Package</a>.
        <br />
    </div>
                ...
                <div data-bind="visible: SelectedFolder() != null">
                    <div class="clearfix">
                        ...
                        <div class="pull-right">
                            <a href="#" data-bind="click: function () { SelectedFolder(null); }">..back to Folders List
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="list-group-item row">
                            <div class="col-sm-8">
                                ...
                                <div class="small">
                                    ...
                                    Manage by User <span class="label label-info" data-bind="text: userId ? userId : 'No User'"></span>
                                    <br />
                                    View only by User <span class="label label-info" data-bind="text: (viewOnlyUserId ? viewOnlyUserId : (userId ? userId : 'Any User'))"></span>
                                    <br />
                                    <!-- ko if: userRole -->
                                    Manage by Role <span class="label label-info" data-bind="text: userRole ? userRole : 'No Role'"></span>
                                    <br />
                                    <!-- /ko -->
                                    <!-- ko if: viewOnlyUserRole -->
                                    View only by Role <span class="label label-info" data-bind="text: viewOnlyUserRole ? viewOnlyUserRole : 'Any Role'"></span>
                                    <br />
                                    <!-- /ko -->
                                    <!-- ko if: clientId -->
        ...
        <div data-bind="with: scheduleBuilder">
            ...
            <div data-bind="if: hasSchedule">
                <div class="form-inline form-group">
                    ...
                    <!-- ko if: showDays -->
                    on
                    <select multiple class="form-control" required style="width: 30%;" data-bind="select2: { placeholder: 'Choose Days', allowClear: true }, options: days, selectedOptions: selectedDays"></select>
                    <!-- /ko -->
                    <!-- ko if: showDates -->
                    on
                    <select multiple class="form-control" required style="width: 30%;" data-bind="select2: { placeholder: 'Choose Dates', allowClear: true }, options: dates, selectedOptions: selectedDates"></select>
                    <!-- /ko -->
                    <!-- ko if: showMonths -->
                    of
                    <select multiple class="form-control" required style="width: 30%;" data-bind="select2: { placeholder: 'Choose Months', allowClear: true }, options: months, selectedOptions: selectedMonths"></select>
                    <!-- /ko -->
                    <!-- ko if: showAtTime -->
                    at
                    <select class="form-control" data-bind="options: hours, value: selectedHour"></select>
